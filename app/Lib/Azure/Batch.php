...
namespace App\Lib\Azure;

use Carbon\Carbon;
use Illuminate\Support\Facades\Log;

use App\Lib\Azure\Batch\PoolTrait;
use App\Lib\Azure\Batch\JobTrait;
use App\Lib\Azure\Batch\TaskTrait;

class Batch
{
    use PoolTrait, JobTrait, TaskTrait;
