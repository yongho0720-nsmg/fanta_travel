...
@section('content')
    <main class="main">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><strong>공지 관리</strong></li>
        </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="float-left mt-2"><i class="icon-screen-smartphone"></i>공지 관리</div>
                            ...
                            <div class="card-body">
                                ...
                                <hr class="mt-0 mb-4">
                                <form class="form-inline" method="GET" action="{{url('/admin/notices')}}">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row pl-3 mt-3">
                                                <div class="form-inline form-group">
                                                    <div class="col"><label for="type">공지 타입 </label></div>
                                                    <div class="input-group">
                                                        <select class="form-control" name="type" id="type">
                                                            <option value="" {{ ($params['type']=='') ? 'selected' : '' }}>전체</option>
                                                            <option value="A" {{ ($params['type']=='A') ? 'selected' : '' }}>전체 공지</option>
                                                            <option value="P" {{ ($params['type']=='P') ? 'selected' : '' }}>개별 공지</option>
                                                        </select>
                                                    </div>
                                ...
                                <hr class="mt-2 mb-4">
                                <form id='delete_post' method="POST" action="{{url('/admin/notices/bulk')}}">
                                    {{ csrf_field() }}
        ...
        <!-- Modal -->
        <div class="modal fade" id="addnoticeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form enctype="multipart/form-data" method="POST" action="{{url('/admin/notices')}}" onsubmit="return value_check()">
                        {{ csrf_field() }}
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle"><strong>공지 등록</strong></h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="create_thumbnail" class="col-sm-2 col-form-label">썸네일</label>
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" name="create_thumbnail" id="create_thumbnail">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="create_content_images" class="col-sm-2 col-form-label">images</label>
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" name="create_content_images" id="create_content_images" multiple>
                                </div>
                            </div>
                        </div>
...
@push('script')
    <script>
        ...
        $('#create_notice_button').on('click',function(e){
            e.preventDefault();
