                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-3 pl-2 pr-2">
                            <div class="card mb-3 border-0">
                                <div class="card-body p-3 d-flex align-items-center rounded-lg shadow-sm" style="background-color: #fff">
                                    <i class="icon-people p-3 font-3xl ml-1 mr-3 rounded-sm shadow-sm position-absolute" style="top:-15px; left:10px; background-color:#448AFF; color: #fff;"></i>
                                    <div style="padding-left: 5rem">
                                        <div class="text-value-lg" style="font-size: 1.4rem;">
                                            75,652
                                            <span class="text-danger text-value-sm" style="font-size: 0.9rem;">+4.3%</span>
                                        </div>
                                        <div class="text-muted font-weight-bold text-uppercase">총 사용자수</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3 pl-2 pr-2">
                            <div class="card mb-3 border-0">
                                <div class="card-body p-3 d-flex align-items-center rounded-sm shadow-sm" style="background-color: #fff">
                                    <i class="icon-user-follow p-3 font-3xl ml-1 mr-3 rounded-sm shadow-sm position-absolute" style="top:-15px; left:10px; background-color:#F06292; color: #fff;"></i>
                                    <div style="padding-left: 5rem">
                                        <div class="text-value-lg" style="font-size: 1.4rem;">
                                            12,452
                                            <span class="text-danger text-value-sm" style="font-size: 0.9rem;">+3.7%</span>
                                        </div>
                                        <div class="text-muted font-weight-bold text-uppercase">신규 사용자수</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3 pl-2 pr-2">
                            <div class="card mb-3 border-0">
                                <div class="card-body p-3 d-flex align-items-center rounded-sm shadow-sm" style="background-color: #fff">
                                    <i class="icon-screen-smartphone p-3 font-3xl ml-1 mr-3 rounded-sm shadow-sm position-absolute" style="top:-15px; left:10px; background-color:#8BC34A; color: #fff;"></i>
                                    <div style="padding-left: 5rem">
                                        <div class="text-value-lg" style="font-size: 1.4rem;">
                                            452,652
                                            <span class="text-danger text-value-sm" style="font-size: 0.9rem;">+7.9%</span>
                                        </div>
                                        <div class="text-muted font-weight-bold text-uppercase" style="color:#fff;">APP 잔존수</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3 pl-2 pr-2">
                            <div class="card mb-3 border-0">
                                <div class="card-body p-3 d-flex align-items-center rounded-sm shadow-sm" style="background-color: #fff">
                                    <i class="icon-bag p-3 font-3xl ml-1 mr-3 rounded-sm shadow-sm position-absolute" style="top:-15px; left:10px; background-color:#FF9800; color: #fff;"></i>
                                    <div style="padding-left: 5rem">
                                        <div class="text-value-lg" style="font-size: 1.4rem;">
                                            54,289
                                            <span class="text-danger text-value-sm" style="font-size: 0.9rem;">-0.9%</span>
                                        </div>
                                        <div class="text-muted font-weight-bold text-uppercase">APP 신규설치수</div>
                                    </div>
                                </div>
                            </div>
                        </div>
