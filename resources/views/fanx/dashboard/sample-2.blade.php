                ...
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-3 pl-2 pr-2">
                            <div class="card mb-3">
                                <div class="card-body p-3 d-flex align-items-center rounded-sm" style="background-color: #fff">
                                    <i class="icon-people p-3 font-3xl ml-1 mr-3 rounded-circle" style="background-color:#448AFF; color: #fff;"></i>
                                    <div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-3 pl-2 pr-2">
                            <div class="card mb-3">
                                <div class="card-body p-3 d-flex align-items-center rounded-sm" style="background-color: #fff">
                                    <i class="icon-user-follow p-3 font-3xl ml-1 mr-3 rounded-circle" style="background-color:#F06292; color: #fff;"></i>
                                    <div>
                                        <div class="text-value-lg" style="font-size: 1.4rem;">
                                            12,452
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-3 pl-2 pr-2">
                            <div class="card mb-3">
                                <div class="card-body p-3 d-flex align-items-center rounded-sm" style="background-color: #fff">
                                    <i class="icon-screen-smartphone p-3 font-3xl ml-1 mr-3 rounded-circle" style="background-color:#8BC34A; color: #fff;"></i>
                                    <div>
                                        <div class="text-value-lg" style="font-size: 1.4rem;">
                                            452,652
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-3 pl-2 pr-2">
                            <div class="card mb-3">
                                <div class="card-body p-3 d-flex align-items-center rounded-sm" style="background-color: #fff">
                                    <i class="icon-bag p-3 font-3xl ml-1 mr-3 rounded-circle" style="background-color:#FF9800; color: #fff;"></i>
                                    <div>
                                        <div class="text-value-lg" style="font-size: 1.4rem;">
                                            54,289
