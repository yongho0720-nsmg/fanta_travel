...
@section('content')
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><strong>오류 리포트</strong></li>
            <!-- Breadcrumb Menu-->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="float-left mt-2"><i class="fa fa-exclamation-circle"></i> 오류 리포트</div>
                                <div class="float-right">
                                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#requestModal"><i class="fa fa-plus"></i> 오류 신고</button>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
            ...
            <div class="modal-content">
                <form id="requestForm">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title"><strong><i class="fa fa-exclamation-circle"></i> 오류 신고</strong></h5>
