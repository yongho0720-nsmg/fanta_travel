...
@section('content')
    <main class="main">
        <form class="form-inline" name="search_form" id="search_form" method="GET" action="{{url('/admin/boards/bulk/v2')}}">
            ...
            <input type="hidden" id="face_check" name="face_check" value="{{$params['face_check']}}">

            <div id="mobile_search_box" class=" w-100 mt-0 mb-0 ml-3">
                <div class="row box ">
                        <h6 class="font-weight-bold ml-5 mt-2">연동날짜</h6>
                        <div class="mb-1">
                            <input type="text" class="form-control datetimepicker ml-5 d-inline-block" value="{{$params['start_date']}}" id="start_date" name="start_date" autocomplete="off" style="width:35% " onchange="submit()">
                            ~
                            <input type="text" class="form-control datetimepicker  d-inline-block" value="{{$params['end_date']}}" id="end_date" name="end_date" autocomplete="off" style="width: 35%" onchange="submit()">
                        </div>
                </div>
                ...
                <div class="row w-100">
                    <div class="box col">
                        ...
                        {{--<select class="form-control ml-1" id="type" name="type" value="{{$params['type']}}" onchange="submit()">--}}
                        {{--<option {{($params['type']==null)? 'selected':''}} value="">전체</option>--}}
                        {{--<option {{($params['type']=='instagram')? 'selected':''}} value="instagram">instagram</option>--}}
                        {{--<option {{($params['type']=='youtube')? 'selected':''}} value="youtube">youtube</option>--}}
                        ...
                        <div  class="custom-radio">
                            @if(Auth::user()!= null && (Auth::user()->app == 'jihoon' || Auth::user()->app == 'krieshachu'))
                                <select class="form-control ml-1" id="type" name="type" value="{{$params['type']}}" onchange="submit()">
                                    ...
                                    <option {{($params['type']=='twitter')? 'selected':''}} value="twitter">twitter</option>
                                    <option {{($params['type']=='myfeed')? 'selected':''}} value="myfeed">myfeed</option>
                                    <option {{($params['type']=='event')? 'selected':''}} value="event">event</option>
                                    <option {{($params['type']=='fanfeed')? 'selected':''}} value="fanfeed">fanfeed</option>
                                </select>
                            ...
                            @else
                                <select class="form-control" id="type" name="type" value="{{$params['type']}}" onchange="submit()">
                                    <option {{($params['type']==null)? 'selected':''}} value="">전체</option>
                                    <option {{($params['type']=='instagram')? 'selected':''}} value="instagram">instagram</option>
                                    <option {{($params['type']=='youtube')? 'selected':''}} value="youtube">youtube</option>
                                    <option {{($params['type']=='news')? 'selected':''}} value="news">news</option>
                ...
                <div class="row">
                    ...
                    <div class="box col p-0">
                        ...
                        {{--<div class="custom-radio row w-100 mx-0">--}}
                            {{--<button type="radio" class="btn {{($params['app_review']==null) ? 'btn-primary':'btn-outline-primary'}} col ml-1 mr-1" name="app_review" value="">전체</button>--}}
                            {{--<button type="radio" class="btn {{($params['app_review']=='1') ? 'btn-primary':'btn-outline-primary'}} col  mr-1" name="app_review" value="1">검수용</button>--}}
                            {{--<button type="radio" class="btn {{($params['app_review']=='0') ? 'btn-primary':'btn-outline-primary'}} col " name="app_review" value="0">검수용X</button>--}}
                        {{--</div>--}}
                    </div>
                </div>
                {{--//////////////////////--}}
                ...
                <div class="row">
                    <div class="box col">
                        ...
                        <div  class="custom-radio row ml-2 w-100">
                            ...
                            {{--<button type="radio" class="btn {{($params['face_check']=='all') ? 'btn-primary':'btn-outline-primary'}} col ml-3 mr-1" name="face_check" value="all">전체</button>--}}
                            {{--<button type="radio" class="btn {{($params['face_check']==null) ? 'btn-primary':'btn-outline-primary'}} col  mr-1" name="face_check" value="">미검수</button>--}}
                            {{--<button type="radio" class="btn {{($params['face_check']=='0') ? 'btn-primary':'btn-outline-primary'}} col mr-1" name="face_check" value="0">없음</button>--}}
                            {{--<button type="radio" class="btn {{($params['face_check']=='1') ? 'btn-primary':'btn-outline-primary'}} col " name="face_check" value="1">있음</button>--}}
                        </div>
                    </div>
                    <div class="box col">
                        ...
                        <div  class="custom-radio row w-100">
                            ...
                            {{--<button type="radio" class="btn {{($params['text_check']=='3') ? 'btn-primary':'btn-outline-primary'}} col ml-2 mr-1" name="text_check" value="3">전체</button>--}}
                            {{--<button type="radio" class="btn {{($params['text_check']=='0') ? 'btn-primary':'btn-outline-primary'}} col mr-1" name="text_check" value="0">미검수</button>--}}
                            {{--<button type="radio" class="btn {{($params['text_check']=='1') ? 'btn-primary':'btn-outline-primary'}} col mr-1 " name="text_check" value="1">없음</button>--}}
                            {{--<button type="radio" class="btn {{($params['text_check']=='2') ? 'btn-primary':'btn-outline-primary'}} col  " name="text_check" value="2">있음</button>--}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row w-100 box">
                    {{--<div class='box  px-0 d-inline-block'>--}}
                        ...
                        {{--</div>--}}
                        <button type="submit" class="d-inline-block btn btn-primary mx-0 mb-3 mr-5" style="float:right;margin: 5px;">검색</button>
                    {{--</div>--}}
                </div>
                {{----}}
                {{--<div class="box form-group col-md-6">--}}
                {{--<div class="row w-100">--}}
                {{--<div class ='col-4 mt-2 px-0 d-inline-block'>--}}
                {{--<h6 class="font-weight-bold">연동날짜</h6>--}}
                {{--<div>--}}
                {{--<input type="text" class="form-control datetimepicker mt-2 d-inline-block" value="{{$params['start_date']}}" id="start_date" name="start_date" autocomplete="off" style="width: 7rem" onchange="submit()">--}}
                {{--~--}}
                {{--<input type="text" class="form-control datetimepicker mt-2 d-inline-block" value="{{$params['end_date']}}" id="end_date" name="end_date" autocomplete="off" style="width: 7rem" onchange="submit()">--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--<hr style="width: 0px; height: 60px; border:0.5px solid black;" class=" mx-3">--}}
                {{--<div class='col-4 mt-2 d-inline-block'>--}}
                {{--<h6 class="font-weight-bold">태그검색</h6>--}}
                {{--<div id="search" class="d-inline-block" style="width:70%">--}}
                {{--                                <search_autocomplete :items= {!! json_encode($tag_list) !!}/>--}}
                {{--<search_autocomplete :items= '{{ $tag_list }}'/>--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--<div class='col-4  mt-2 px-0 d-inline-block'>--}}
                {{--<h6 class="font-weight-bold">키워드검색</h6>--}}
                {{--<div id="s_search" class="d-inline-block" style="width:70%">--}}
                {{--                                <search_autocomplete :items= {!! json_encode($tag_list) !!}/>--}}
                {{--<s_search_autocomplete :items= '{{ $search_list }}'/>--}}
                {{--</div>--}}
                {{--<div  class="custom-radio d-inline-block">--}}
                {{--<input class="form-control  mb-3" type="text" name="search" value="{{$params['search']}}">--}}
                {{--</div>--}}
                {{--<button type="submit" class="d-inline-block btn btn-primary mx-0 mb-3" style="margin: 5px;">검색</button>--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--</div>--}}
                ...
                {{--</div>--}}
                {{--<div class="box form-group col-md-1">--}}
                {{--<h6 class="font-weight-bold">구글 검수</h6>--}}
                {{--<div  class="custom-radio row w-100">--}}
                {{--<select class="form-control ml-1" id="app_review" name="app_review" value="{{$params['app_review']}}" onchange="submit()">--}}
                {{--<option {{($params['app_review']==null)? 'selected':''}} value="">전체</option>--}}
                {{--<option {{($params['app_review']=='1')? 'selected':''}} value="1">검수용</option>--}}
                ...
                {{--</div>--}}
                {{--<div class="box form-group col-md-1">--}}
                {{--<h6 class="font-weight-bold">얼굴</h6>--}}
                {{--<div  class="custom-radio row w-100">--}}
                {{--<select class="form-control ml-1" id="face_check" name="face_check" value="{{$params['face_check']}}" onchange="submit()">--}}
                {{--<option {{($params['face_check']=='all')? 'selected':''}} value='all'>전체</option>--}}
                {{--<option {{($params['face_check']==null)? 'selected':''}} value=''>미검수</option>--}}
                ...
                {{--</div>--}}
                {{--<div class="box form-group col-md-1">--}}
                {{--<h6 class="font-weight-bold">텍스트</h6>--}}
                {{--<div  class="custom-radio row w-100">--}}
                {{--<select class="form-control ml-1" id="text_check" name="text_check" value="{{$params['text_check']}}" onchange="submit()">--}}
                {{--<option {{($params['text_check']=='3')? 'selected':''}} value="3">전체</option>--}}
                {{--<option {{($params['text_check']=='0')? 'selected':''}} value="0">미검수</option>--}}
            ...
            <div id="search_box" class=" w-100 mt-0 mb-0">
                <div class="row">
                    ...
                    <div class="box col-4">
                        <h6 class="font-weight-bold mt-2">종류</h6>
                        {{--<select class="form-control ml-1" id="type" name="type" value="{{$params['type']}}" onchange="submit()">--}}
                            {{--<option {{($params['type']==null)? 'selected':''}} value="">전체</option>--}}
                            {{--<option {{($params['type']=='instagram')? 'selected':''}} value="instagram">instagram</option>--}}
                            {{--<option {{($params['type']=='youtube')? 'selected':''}} value="youtube">youtube</option>--}}
...
{{--                                    <option {{($params['type']=='web')? 'selected':''}} value="web">web</option>--}}
                                ...
                                {{--<button type="radio" class="btn {{($params['type']=='event')? 'btn-primary':'btn-outline-primary'}} col mx-1"  name="type" value="event" >event</button>--}}
                            @else
                                <button type="radio" class="btn {{($params['type']==null)? 'btn-primary':'btn-outline-primary'}} col ml-3 mr-1" name="type" value="">전체</button>
                                <button type="radio" class="btn {{($params['type']=='instagram')? 'btn-primary':'btn-outline-primary'}} col mx-1"  name="type" value="instagram" >instagram</button>
                                <button type="radio" class="btn {{($params['type']=='youtube')? 'btn-primary':'btn-outline-primary'}} col mx-1"  name="type" value="youtube" >youtube</button>
                                <button type="radio" class="btn {{($params['type']=='news')? 'btn-primary':'btn-outline-primary'}} col mx-1"  name="type" value="news" >news</button>
                                <button type="radio" class="btn {{($params['type']=='web')? 'btn-primary':'btn-outline-primary'}} col mx-1"  name="type" value="web" >web</button>
                            @endif
                        </div>
                    </div>
                    <div class="box col">
                        ...
                        <div  class="custom-radio row w-100 ml-2">
                            ...
                            {{--</select>--}}
                            <div  class="custom-radio row w-100">
                                <button type="radio" class="btn {{($params['state']==null)? 'btn-primary':'btn-outline-primary'}} col-3 text-center" name="state" value="">전체</button>
                                <button type="radio" class="btn {{($params['state']=='2')? 'btn-primary':'btn-outline-primary'}} col-3 text-center"  name="state" value="2" >비게시</button>
                                <button type="radio" class="btn {{($params['state']=='1')? 'btn-primary':'btn-outline-primary'}} col-3 text-center"  name="state" value="1" >게시</button>
                                <button type="radio" class="btn {{($params['state']=='0')? 'btn-primary':'btn-outline-primary'}} col-3 text-center"  name="state" value="0" >미검수</button>
                            </div>
                        </div>
                    </div>
                    <div class="box col p-0">
        ...
        <div class="p-2" style="border:1px solid #CFCFCF">
            <h6>Total: {{$total}}</h6>
            <form name="form_{{$params['type']}}" id="form_{{$params['type']}}" method="post" action="{{url('/admin/boards/bulk')}}">
                {{ csrf_field() }}
                ...
                <div class="container-fluid">
                    <div class="row py-1">
                        <div class="col">
                            ...
                            <button type="button" name="alldrop" class="icon-options-vertical btn btn-primary mb-2"></button>
                            <button type="button" class="btn btn-primary mb-2" name="check_all" id="check_all" value=0>전체 선택</button>
                            ...
                            <button type="button" class="btn btn-primary" style="float: right;margin:3px" name="threedaysago">3일 전</button>
                            <button type="button" class="btn btn-primary" style="float: right;margin:3px" name="twodaysago">2일 전</button>
                            <button type="button" class="btn btn-primary" style="float: right;margin:3px" name="onedaysago">1일 전</button>
                            <button type="button" class="btn btn-primary" style="float: right;margin:3px" name="today">today</button>
                        </div>
                    </div>
                </div>
                <div class="container-fluid position-fixed invisible" style="z-index:400;border:1px solid black ;background: white;width: 90%;" id="menu_bar">
                    <div class="row py-1">
                        <div class="col">
                            <button type="button" name="alldrop" class="icon-options-vertical btn btn-primary mb-2"></button>
                ...
                <div id = "columns" class="grid" style="height: 100%">
                    @foreach($rows as $val)
                        <div class = "grid-item {{($val->state==1)? 'border-success' : 'border-warning'}} custom-checkbox card">
                            <div class="dropdown position-absolute" style="z-index: 10; right: 0rem;" id="{{$val->id}}_dropdown">
                                <span type='button' class="dropbtn icon-options-vertical btn-primary p-1 pt-2"  id="{{$val->id}}_dropbtn"></span>
                                <div class="dropdown-content p-2 1" style="width: 215px; right: 0rem; border-bottom:1px solid black" id="{{$val->id}}_dropdown-content">
                                    <div>
                                        <div class="row w-100 ml-0">
                                            <div class="col-2 p-0"><span data-feather="tag"></span><p>태그</p></div>
                                            <div id='A_tag' class="col-10 p-0">
                                                ...
                                                @if(isset($val->ori_tag[0]) && $val->ori_tag[0] != null)
                                                    ...
                                                    @endif
                                                    ...
                                                    <div class="d-inline-block float-right">{{count($val->ori_tag)}}개</div>
                                                @else
                                                    ...
                                                ...
                                                @if(isset($val->custom_tag[0]) && $val->custom_tag[0] != null)
                                                    ...
                                                    ...
                                                    <button type='button' class='float-right' name="individual_modify_tag" value="{{$val->id}}" style="font-size: 0.5rem;">수정</button>
                                                    <div class="d-inline-block float-right">{{count($val->custom_tag)}}개</div>
                                                @else
                                                    ...
                                                    <button type='button' class='float-right' name="individual_modify_tag" value="{{$val->id}}" style="font-size: 0.5rem;">수정</button>
                                                    <div class="d-inline-block float-right">0개</div>
                                        ...
                                        <div class="row w-100 ml-0">
                                            ...
                                            <div class="col-10 pr-0">
                                                <div class="row" id="{{$val->id}}_check">
                                                    <button type="button" class='col-3 p-1 m-1 {{($val->text_check=='0') ? 'btn-primary':'btn-outline-primary'}}' style="font-size:0.5rem" name = "not_checked" disabled>미검수</button>
                                                    <button type="button" class='col-3 p-1 m-1 {{($val->text_check=='1') ? 'btn-primary':'btn-outline-primary'}}' style="font-size:0.5rem" name = "individual_not" value="{{$val->id}}">없음</button>
                                                    <button type="button" class='col-3 p-1 m-1 {{($val->text_check=='2') ? 'btn-primary':'btn-outline-primary'}}' style="font-size:0.5rem" name = "individual_text" value="{{$val->id}}">있음</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row w-100 ml-0">
                                            ...
                                            <div class="col-10">
                                                <div class="row" id="{{$val->id}}_open">
                                                    <button type="button" class='col-3 p-1 m-1 {{($val->state=='2') ? 'btn-primary':'btn-outline-primary'}}' style="font-size:0.5rem" name="individual_close" value="{{$val->id}}">비게시</button>
                                                    <button type="button" class='col-3 p-1 m-1 {{($val->state=='1') ? 'btn-primary':'btn-outline-primary'}}' style="font-size:0.5rem" name="individual_open" value="{{$val->id}}">게시</button>
                                                    <button type="button" class='col-3 p-1 m-1 {{($val->state=='0') ? 'btn-primary':'btn-outline-primary'}}' style="font-size:0.5rem" name="not_checked_to_open" value="{{$val->id}}" disabled>미검수</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <label class="custom-control-label " for="{{$val->id}}">
                                ...
                                @if(isset($val->new))
                                    <div style="position: absolute; background: black;top:30px;right:0%;"><h4 style="color: yellow;">new</h4></div>
                                @endif
                                @if($val->text_check==2)
        ...
        <div class="row justify-content-md-center invisible" id="ajax_loading"><img src="{{env('PUBLIC_PATH')}}/images/loading_spinner.gif" height="100" width="100"></div>
        ...
        <div id="dialog-form">
            ...
            <button type="submit" id="btn_real_open" name="btn_real_open" class="btn mt-4 font-weight-bold" style="width: 50%;margin-left: 175px;">게시하기</button>
        </div>
        ...
        <div id = "modify_tag_form">
            ...
            <button type="submit" id="btn_modify_tags" name="btn_modify_tags" class="btn mt-4 font-weight-bold" style="width: 50%;margin-left: 175px;">수정하기</button>
            {{--2019.01.31 cch 태그 버튼구현 테스트--}}
        </div>
        {{--2019.01.28 cch 공통태그 alert 추가--}}
        ...
        <div id = "individual_modify_tag_form">
            ...
            <button type="submit" id="btn_individual_modify_tags" name="btn_individual_modify_tags" class="btn mt-4 font-weight-bold" style="width: 50%;margin-left: 175px;">수정하기</button>
            {{--2019.01.31 cch 태그 버튼구현 테스트--}}
        </div>
        {{--개별 수정 폼 추가--}}
        ...
        <div id = "create_form" style="overflow-x:hidden">
            ...
            <h4>Input Tool</h4>
            <form enctype="multipart/form-data" id="create_{{$params['type']}}" name="create_{{$params['type']}}" method="POST" action="{{url('/admin/boards?type='.$params['type'])}}">
                ...
                <div class="form-group row" id="input">
                    ...
                    <div class="col-sm-10">
                        <ul>
                            <button type ="button" v-for="tag in tags" v-text="tag"  class="tag" v-on:click="removeTag" ></button>
                        </ul>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="file" name="thumbnail" id="thumbnail" class="form-control-file" style="background: white; width: 100%;">
                        <img id="blah" src="#" alt="need image" />
                    </div>
                </div>
            </form>
            <button type="submit"   id="create_article" name="create_article" class = "btn mt-4 font-weight-bold" style="width: 50%;margin-left: 175px;color:black;">등록</button>
