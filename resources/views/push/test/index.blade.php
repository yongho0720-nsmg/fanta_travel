...
@section('content')
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><strong>테스트 푸시 알림</strong></li>
        </ol>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    <a href="/push/form/0/test" class="btn btn-success mb-2" role="button">새 게시물</a>
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-inline" method="GET" action="{{url('/push/test')}}">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="row pl-3">
                                ...
                                <hr class="mt-2 mb-4">
                                <form id='delete_post' method="POST" action="{{url('/push/delete/test')}}">
                                    {{ csrf_field() }}
