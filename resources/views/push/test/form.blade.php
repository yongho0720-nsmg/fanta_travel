                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form enctype="multipart/form-data" method="POST" action="{{
                                    ($id == '0') ? url('/push/store/test') : url('/push/update/test')
                                    }}">
                                    {{--@if ($id == '0')--}}
                                    ...
                                    <div class="action_S">
                                        <div class="form-group row">
                                            <label for="streaming_url" class="col-sm-2 col-form-label">streaming</label>
                                            <div class="col-sm-10">
                                                <select class="form-control" name="streaming_url" id="streaming_url">
                                                    <option value=""  @if($rows != null && isset(json_decode($rows->streaming_url)->id))@endif disabled selected> 선택 </option>
                                                    @foreach($melon_streamings as $melon_streaming)
                                    ...
                                    <a href="/push/test"><button type="button" class="btn btn-light">목록</button></a>
                                </form>
                            </div>
                        </div>
                    </div>
