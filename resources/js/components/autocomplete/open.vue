<template>
    <div id="alertbox" class="autocomplete row mx-3" style="background: #cdcdcd;
            border: 1px solid #cfcfcf;
            border-radius: 6px; ">
        <div class="col box">
            <h5 class="font-weight-bold">(공통) # (Tag)를 등록</h5>
            <input type="text" name="add_custom_tag" id="add_custom_tag"
                   placeholder="# (Tag) 입력 칸" class="text ui-widget-content ui-corner-all form-control"
                   v-model="newTag"
        ...
        methods: {
            ...
            onEnter() {
                if(this.isOpen == false){
                    ...
                    }else if(tag_list_open.tags.indexOf(this.newTag) == -1){
