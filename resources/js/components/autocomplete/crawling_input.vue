<template>
    <div class="autocomplete">
        <input type="text"  id="input" name="input" class="w-100" style="font-size: 1.38rem;"
               placeholder="입력 칸"
               v-model="newTag"
               @input="onChange" @keyup.down="onArrowDown" @keyup.up="onArrowUp" @keyup.enter="onEnter" autocomplete="off" autofocus>
        ...
        methods: {
            ...
            onEnter() {
                if(this.isOpen==false){
                    ...
                    // else{this.newTag = this.results[this.arrowCounter];}
                    this.arrowCounter =-1;
                    this.isOpen=false;
                }
            },
