    ...
    render() {
        ...
        const breadcrumb = (
            <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active"><strong>삭제</strong></li>
            </ol>
        );

        const contentHead = (
            <div className="card-header">
                <div className="float-left mt-2"><i className='' style={{'marginRight':'3px'}}> </i>삭제 수</div>
...
if (document.getElementById('pf_react_uninstalled')) {
    ReactDOM.render(<UnInstalled />, document.getElementById('pf_react_uninstalled'));
}