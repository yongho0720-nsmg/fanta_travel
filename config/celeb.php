...
return [
    ...
    'fantatravel' => [
        // CDN 주소
        'cdn' => 'https://fantatravel-cdn.azureedge.net/',
        // FCM 서버키
        ...
        //구글 마켓 공유
        'shared_url'    => 'https://play.google.com/store/apps/details?id=com.curation.fantatravel',

        'app_name' => 'fantatravel',        //앱 이름

        'celeb_name' => 'fantatravel',         //셀럽 이름
        'artist_name'    => '',
